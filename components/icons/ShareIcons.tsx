...
export const FacebookIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2.04c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm2.5 10.5h-2v7h-3v-7h-1.5v-3h1.5v-2c0-1.25.6-2.5 2.5-2.5h2v3h-1.5c-.25 0-.5.25-.5.5v1.5h2l-.5 3z" />
    </svg>
);